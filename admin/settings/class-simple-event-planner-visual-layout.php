            ...
            <div class="visual-layout-section-1">
                ...
                <ul id="vl-col-one" class="visual-layout-list visual-layout-list-items">
                    ...
                    if (!empty($sep_event_options['sep_event_map'])) {
                        ...
                        $visual_layout1 = isset($sep_event_options['sep_event_layout_col2']) ? esc_attr($sep_event_options['sep_event_layout_col2']) : esc_attr( $default1 );
                    } else {
                    ...
                    foreach ($event_col1 as $value) {
                        if (!empty($value)) {
                            ?><li data-id="<?php echo esc_attr( $value ); ?>" class="item default-item-1">
                                <span><?php echo ucwords(str_replace('_', ' ', esc_attr( $value ) ) ); ?></span>
                            </li><?php
                        }
                    }
                    ?>
            ...
            <div class="visual-layout-section-2">
                ...
                <ul id="vl-col-two" class="visual-layout-list visual-layout-list-items">
                    ...
                    if (!empty($sep_event_options['sep_event_map'])) {
                        ...
                        $visual_layout2 = isset($sep_event_options['sep_event_layout_col1']) ? esc_attr($sep_event_options['sep_event_layout_col1']) : esc_attr( $default2 );
                    } else {
                    ...
                    foreach ($event_col2 as $value) {
                        if (!empty($value)) {
                            ?><li data-id="<?php echo esc_attr( $value ); ?>" class="item default-item-2">
                                <span><?php echo ucwords(str_replace('_', ' ', esc_attr( $value ) )); ?></span>
                            </li><?php
                        }
                    }
