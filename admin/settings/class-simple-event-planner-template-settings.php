...
class Simple_Event_Planner_Appearance_Settings {
    ...
    public function sep_add_appearance_settings_section() {
        ...
        <ul class="form-elements">
            ...
            <li class="element-field">               
                <input type="text" id="container-id" name="sep_container_id" value="<?php echo esc_attr( $sep_event_options['sep_container_id'] ); ?>" autocomplete="off" />
            </li>
        </ul>
        <ul class="form-elements">
            <li class="field-label">
        ...
        <ul class="form-elements">
            ...
            <li class="element-field">               
                <input type="text" id="cptSlug-id" name="cptSlug-id" value="<?php echo esc_attr( $cpt_slug_setting ); ?>" autocomplete="off" />
            </li>
        </ul>
        ...
        <ul class="form-elements">
            ...
            <li class="element-field-date">
                <input <?php echo esc_attr( $custom );?> type="radio" name="sep_date_format" id="sep_date_format" value="<?php echo esc_attr( $set ); ?>"><?php esc_html_e(' Custom:', 'simple-event-planner'); ?>
                <input type="text" name="date_format_custom" id="sep_date_format_text" value="<?php echo esc_attr( $set ); ?>" class="small-text">
                <p class="example-text"><strong><?php esc_html_e(' Preview:', 'simple-event-planner'); ?></strong> <span class="example"><?php echo esc_attr( date($set) ); ?></span></p>
            </li>
        </ul>
        <div class="clear"></div>
        <?php
