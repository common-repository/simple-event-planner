...
class Simple_Event_Planner_Settings_Init {
    ...
    public function __construct() {
        ...
        /**
         * Calling file containing functionality of general settings.
         */
        ...
        /**
         * Calling file containing functionality of Gmap API key settings.
         */
        ...
        /**
         * Calling file containing functionality of Appearance settings.
         */
        ...
        /**
         * Calling file containing functionality of Visual Layout.
         */
    ...
    public function sep_settings_tab_menu() {
        ...
        <div class="sep-wrap">
            ...
            <!-- Event Planner Settings Form -->
            <form id="optioin_frm" method="post" action="javascript:sep_event_option_save('<?php echo esc_url( admin_url('admin-ajax.php') ); ?>', '<?php echo esc_attr( get_template_directory_uri() ); ?>');">
                ...
                <div class="sep-container-fluid pt-wrapper-bg">
                    <div class="sep-col-lg-2 sep-col-md-3 sep-col-sm-4 sep-col-xs-2" style="padding:0;">
                        ...
                        <div class="sep-sidebar">
                            <div class="branding">
                                ...
                                <?php echo esc_attr( $sep_version->get_version() ); ?>
                            </div>
                            <div class="main-nav">
                                <ul class="sub-menu categoryitems" style="display:block">
                                    ...
                                    foreach ($settings_tabs as $key => $tab_name) {
                                        ...
                                        <li class="<?php echo esc_attr( $active_tab ) ?>">
                                            <a href="#<?php echo esc_attr($key); ?>-settings" onClick="toggleDiv(this.hash);
                                                                return false;">
                    ...
                    <input type="hidden" name="sep_nonce" value="<?php echo esc_attr( wp_create_nonce('sep_security_nonce') ); ?>">
                </div>
            </form>
        </div>
        <?php
