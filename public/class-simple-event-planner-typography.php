    ...
    public function sep_typography() {
        ...
        if (is_sep()) {
            ...
            <style type="text/css">
                ...
                {
                    background-color: <?php echo esc_attr( $event_primary_color ); ?>;
                }

                .sep-page .pagination li span.current {                    
                    border-color: <?php echo esc_attr( $event_primary_color ); ?>;
                }
                ...
                {
                    color: <?php echo esc_attr( $event_primary_color ); ?>;  
                }

                /* Secondary Color Styles */
                .sep-page .grid-view article, .sep-page .list-view article 
                {
                    background-color: <?php echo esc_attr( $event_secondary_color ); ?>;
                }                
                ...
                {
                    color: <?php echo esc_attr( $event_title_color ); ?>;
                }
                ...
                {
                    color: <?php echo esc_attr( $event_content_color ); ?>; 
                }
            </style> 
            <?php
        }
