...
<div class="search ">
    ...
    <div class="form-group">
        ...
        <form action="<?php echo esc_url(home_url('/')) . $slug; ?>" method="get">
            <input class="form-control" type="text" name="search_keyword" value="<?php echo esc_attr( $search_keyword ); ?>" placeholder="<?php esc_html_e('Search by Event Title', 'simple-event-planner') ?>" />
