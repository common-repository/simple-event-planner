...
$organiser = sep_get_the_event_organizer();
...
<div class="google-calendar-ical">
    ...
    if (('' !== sep_get_the_event_start_date() && '' !== sep_get_the_event_end_date()) && ( $startDate >= $today )) {
        ?>
        <a href="<?php echo esc_url($google_cal_url); ?>" target="_blank" rel="nofollow"> <?php esc_html_e('Add to Google Calendar', 'simple-event-planner') ?> </a>
        <a href="<?php echo esc_url($iCal_url); ?>"> <?php esc_html_e('Add to iCal', 'simple-event-planner') ?> </a>
        <?php
    }
    ?>
</div>
